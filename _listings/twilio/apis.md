...
- name: Twilio
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/applications/master/_listings/twilio/accounts-accountsid-applications-applicationsid-format-delete.md
x-common:
- type: x-net-library
